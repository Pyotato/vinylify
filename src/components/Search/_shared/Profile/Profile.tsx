...
const Profile = ({ profile }: { profile: ProfileProps }) => {
  return (
    <div
      className={`inline-block nth-[1]:z-[100] nth-[2]:z-[99] nth-[2]:ml-[-20px] ${profile?.imgUrl === SKELETON_PROFILE.imgUrl ? 'float-start' : 'nth-[2]:animate-slide nth-[3]:animate-slide  nth-[4]:animate-slide '} nth-[3]:z-[98] nth-[3]:ml-[-20px]  nth-[4]:z-[97] nth-[4]:ml-[-20px] group-hover:opacity-60 hover:!opacity-100 hover:!z-[100]`}
    >
      <Link
        className={
